<button type="button" class="btn btn-primary pull-right" data-toggle="modal"
        data-target=".bs-example-modal-lg">Nuevo Catálogo
</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Crear Catálogo</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    {!! Form::open(['url' => '/catalogues', 'method' => 'POST', 'files' => true]) !!}
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('title', '', ['class' => 'form-control', 'id' => 'recipient-name', 'placeholder' => 'Título del Catálogo']) }}
                        </div>
                        <div class="form-group">
