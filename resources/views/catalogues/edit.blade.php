...
@section('content')
    <div class="container">
        <div class="row">
            ...
            {!! Form::model(
                $catalogue,
                ['route' => ['catalogues.update', $catalogue->id],
                'class' => 'form-horizontal',
                'method' => 'PUT',
                'files' => true]) !!}

            {{ Form::hidden('id', $catalogue->id) }}
            ...
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('title', $catalogue->title, ['class' => 'form-control', 'id' => 'recipient-name']) }}
                </div>
                <div class="form-group">
                    {{ Form::label('Descripcion', null, ['class' => 'control-label']) }}
                    {{ Form::textarea('description', $catalogue->description, ['class' => 'form-control', 'rows' => '3', 'id' => 'message-text']) }}
                </div>
                <div class="form-group">
                    {{ Form::select('status', ['active' => 'Activo', 'inactive' => 'Inactivo'], $catalogue->status, ['class' => 'form-control']) }}
                </div>
                <div class="form-group">
