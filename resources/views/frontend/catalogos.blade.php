                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="single-product">
                                            <div class="single-product-img">
                                                <a href="/catalogos/{{ $catalogue->id }}/categorias/"><img class="img-home" src="{{ url("images/catalogues/$catalogue->image") }}"
                                                                 alt="{{ $catalogue->title }}"></a>
                                            </div>
                                            <div class="single-product-hover">
                                                <div class="single-product-hover-text">
                                                    <h4><a href="/catalogos/{{ $catalogue->id }}/categorias/">{{ $catalogue->title }}</a></h4>
