<button type="button" class="btn btn-primary pull-right" data-toggle="modal"
        data-target="#crear">Nuevo Producto
</button>

<!-- Modal -->
<div class="modal fade bs-crear-modal-lg" id="crear" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    {!! Form::open(['url' => '/categories/'.$category_id.'/products', 'method' => 'POST', 'files' => true]) !!}
